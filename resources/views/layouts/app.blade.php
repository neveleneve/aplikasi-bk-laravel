                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li><a href="{{ url('/services') }}"
                                    class="nav-link {{ starts_with(Route::currentRouteName(), 'services') ? 'active' : '' }}">Layanan</a>
                            </li>
                            <li><a href="{{ url('/record') }}"
                                    class="nav-link {{ starts_with(Route::currentRouteName(), 'record') ? 'active' : '' }}">Bimbingan</a>
                            </li>
