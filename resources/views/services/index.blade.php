                            ...
                            @foreach ($services as $service)
                                <li class="list-group-item">
                                    <div style="padding: 10px;">
                                        ...
                                        &nbsp;&nbsp;
                                        <a href="/services/{{ $service->id }}/edit" class="btn btn-primary">Ubah Data</a>
                                    ...
                                    <ul class="list-group list-group-flush">
                                        @foreach ($service->subservices as $subservice)
                                            <li class="list-group-item">{{ $subservice->name }}
                                                &nbsp;&nbsp;
                                                <a href="/subservices/{{ $subservice->id }}/edit"
                                                    class="btn btn-outline-primary btn-sm">Ubah Data</a>
                                        ...
                                        @endforeach
                                        <li class="list-group-item">
                                            <a href="/subservices/{{ $service->id }}/create"><span
                                                    class="btn btn-outline-primary btn-sm">Tambah sub Layanan</span></a>
                                        </li>
                                    </ul>
                                </li>
                            @endforeach
