                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input name="code" type="text" class="form-control"
                                        ...
                                        value="{{ old('code') ? old('code') : $student->code }}">
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="level" class="form-control">
                                        ...
                                        @for ($i = 10; $i <= 12; $i++)
                                            <option
                                                @if (old('level')) @if (old('level') == $i)
                                                    selected @endif
                                            @else @if ($student->level == $i) selected @endif @endif
                                                >
                                                {{ $i }}
                                            </option>
                                        @endfor
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="program" class="form-control">
                                        ...
                                        @foreach ($programs as $program)
                                            <option
                                                @if (old('program')) @if (old('program') == $program)
                                                    selected @endif
                                            @else @if ($student->program == $program) selected @endif @endif
                                                >
                                                {{ $program }}
                                            </option>
                                        @endforeach
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="room" class="form-control">
                                        ...
                                        @for ($i = 1; $i <= 5; $i++)
                                            <option
                                                @if (old('room')) @if (old('room') == $i)
                                                    selected @endif
                                            @else @if ($student->room == $i) selected @endif @endif
                                                >
                                                {{ $i }}
                                            </option>
                                        @endfor
